...
const button2 = getElementById('btn-answ1')
const button3 = getElementById('btn-answ2')
const button4 = getElementById('btn-answ3')
...
const submitq = document.getElementById('submit')
